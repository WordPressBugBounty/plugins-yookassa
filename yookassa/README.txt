...
* Обновлен SDK до 2.14.2

= 2.16.3 =
* Фикс синхронизации списка payment_subject
* Правки для более стабильной работы модуля

= 2.16.2 =
* Фикс возможной уязвимости
* Обновлен SDK до 2.14.1
...
* Добавлен фокус на первое свободное поле в попапе с маркировкой
* Обновлен SDK до 2.13.2
